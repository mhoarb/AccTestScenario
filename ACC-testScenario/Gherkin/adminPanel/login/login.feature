Feature: Admin Panel Login
  As an admin user
  I want to log into the admin panel at https://admin-club.farazpardazan.com/auth/login
  So that I can manage the system

  Scenario: Successful login with valid admin credentials
    Given the user is on the admin login page at https://admin-club.farazpardazan.com/auth/login
