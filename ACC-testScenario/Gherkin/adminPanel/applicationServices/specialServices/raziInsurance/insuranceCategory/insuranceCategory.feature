...
Feature: Category Management
    As a super admin
    I want to manage categories "https://admin-club.farazpardazan.com/razi-category"
    So that I can organize and track items effectively

    Background:
        Given I am logged in as a super admin
        And I am on the Category page "https://admin-club.farazpardazan.com/razi-category"
    ...
    Scenario: Edit an existing category
        Given there is a category named "بیمه بدنه اتومبیل"
        When I click on the "Edit" icon next to "بیمه بدنه اتومبیل"
        And I update the "عنوان" field to "بیمه شخص ثالث"
        And I click on the "ثبت" button
        Then the category should be updated to "بیمه شخص ثالث"
        And the updated category should be visible in the list

    Scenario: Delete an existing category
        Given there is a category named "بیمه بدنه اتومبیل"
        When I click on the "Delete" icon next to "بیمه بدنه اتومبیل"
        And I confirm the deletion
        Then the category "بیمه بدنه اتومبیل" should be removed from the list
