Feature: Admin Panel Login, Dashboard, and razi-shopping
    As an admin user
    ...
    Scenario: Verify razi-shopping table structure for Number of razi-shoppings
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping page at https://admin-club.farazpardazan.com/razi-shopping
        When the page loads
    ...
    Scenario: Activate a row in the razi-shopping table
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping page at https://admin-club.farazpardazan.com/razi-shopping
    ...
    Scenario: Deactivate a row in the razi-shopping table
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping page at https://admin-club.farazpardazan.com/razi-shopping
    ...
    Scenario: Delete a row from the razi-shopping table
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping page at https://admin-club.farazpardazan.com/razi-shopping
    ...
    Scenario: Edit a row in the razi-shopping table
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping page at https://admin-club.farazpardazan.com/razi-shopping
        When the user selects a row
    ...
    Scenario: View comments for a row in the razi-shopping table
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping page at https://admin-club.farazpardazan.com/razi-shopping
        When the user selects a row
    ...
    Scenario: View tickets for a row in the razi-shopping table
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping table at https://admin-club.farazpardazan.com/razi-shopping
        When the user selects a row
        And the user clicks the view tickets action
        Then new page displays the tickets associated with the row

    Scenario: Register a new purchase center "ثبت کد خرید"
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping page at https://admin-club.farazpardazan.com/razi-shopping
    ...
    Scenario: Export razi-shopping table to Excel
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping page at https://admin-club.farazpardazan.com/razi-shopping
    ...
    Scenario: Perform pagination on razi-shopping table
        Given the user is logged into the admin panel as "superadmin"
        And the user is on the razi-shopping page at https://admin-club.farazpardazan.com/razi-shopping
