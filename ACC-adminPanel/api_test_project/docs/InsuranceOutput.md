...
json = "{}"
# create an instance of InsuranceOutput from a JSON string
insurance_output_instance = InsuranceOutput.from_json(json)
# print the JSON string representation of the object
print(InsuranceOutput.to_json())

# convert the object into a dict
insurance_output_dict = insurance_output_instance.to_dict()
# create an instance of InsuranceOutput from a dict
insurance_output_from_dict = InsuranceOutput.from_dict(insurance_output_dict)
```
