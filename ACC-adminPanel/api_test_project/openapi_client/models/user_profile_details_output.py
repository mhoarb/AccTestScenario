...
class UserProfileDetailsOutput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "profilePictureId", "customerNumber", "userLevelType", "isShowName", "firstName", "lastName", "nationalId", "mobileNumber", "birthday", "fatherName", "job", "email", "address", "education", "postalCode", "telephone", "maritalStatus", "marriedTime", "childrenCount", "childrenBirthdayTime", "customerType", "branchId", "branchCode", "branchName", "complete", "isAcceptor"]
