...
class RequestCalculateScoreResponseDTO(BaseModel):
    """
    ...
    user_groups: Optional[List[UserGroupResponseDTO]] = Field(default=None, alias="userGroups")
    __properties: ClassVar[List[str]] = ["id", "name", "effectiveDate", "expirationDate", "userGroups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userGroups": [UserGroupResponseDTO.from_dict(_item) for _item in obj["userGroups"]] if obj.get("userGroups") is not None else None
        })
        return _obj
