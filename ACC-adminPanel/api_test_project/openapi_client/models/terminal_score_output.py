...
class TerminalScoreOutput(BaseModel):
    """
    TerminalScoreOutput
    """ # noqa: E501
    terminal: Optional[TerminalOutput] = None
    score: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["terminal", "score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "terminal": TerminalOutput.from_dict(obj["terminal"]) if obj.get("terminal") is not None else None,
            "score": obj.get("score")
        })
        return _obj
