...
class ReportLuckyWheelParticipateInput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "customerNumber", "userLevelType", "prizeTitle", "fromDate", "toDate"]
