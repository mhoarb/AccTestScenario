...
class CustomerLevelHistoryResponseDTO(BaseModel):
    """
    ...
    old_level: Optional[StrictStr] = Field(default=None, alias="oldLevel")
    new_level: Optional[StrictStr] = Field(default=None, alias="newLevel")
    change_date: Optional[datetime] = Field(default=None, alias="changeDate")
    score: Optional[StrictInt] = None
    changed_by_user_id: Optional[StrictInt] = Field(default=None, alias="changedByUserId")
    change_reason: Optional[StrictStr] = Field(default=None, alias="changeReason")
    __properties: ClassVar[List[str]] = ["id", "userId", "customerNumber", "oldLevel", "newLevel", "changeDate", "score", "changedByUserId", "changeReason"]
