...
class NaturalPerson(BaseModel):
    ...
    national_code: Optional[StrictStr] = Field(default=None, alias="nationalCode")
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "nationalCode", "fatherName", "gender", "birthDate", "maritalStatus", "childrenCount", "job", "education", "address", "postalCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nationalCode": obj.get("nationalCode"),
