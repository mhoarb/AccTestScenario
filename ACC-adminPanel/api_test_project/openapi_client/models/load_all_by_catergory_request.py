...
class LoadAllByCatergoryRequest(BaseModel):
    """
    LoadAllByCatergoryRequest
    """ # noqa: E501
    input: Optional[ReportNotificationInput] = None
    pageable: Optional[Pageable] = None
    __properties: ClassVar[List[str]] = ["input", "pageable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "input": ReportNotificationInput.from_dict(obj["input"]) if obj.get("input") is not None else None,
