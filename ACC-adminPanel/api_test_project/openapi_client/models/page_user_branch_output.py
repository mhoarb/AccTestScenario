...
class PageUserBranchOutput(BaseModel):
    """
    ...
    content: Optional[List[UserBranchOutput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [UserBranchOutput.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
