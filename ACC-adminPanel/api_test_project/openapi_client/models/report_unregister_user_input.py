...
class ReportUnregisterUserInput(BaseModel):
    """
    ReportUnregisterUserInput
    """ # noqa: E501
    his_date: datetime = Field(alias="hisDate")
    ...
    __properties: ClassVar[List[str]] = ["hisDate", "firstName", "lastName", "customerNumber", "customerLevel", "mobileNumber", "sex"]
