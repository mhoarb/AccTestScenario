...
class PageCommentOutput(BaseModel):
    """
    PageCommentOutput
    """ # noqa: E501
    ...
    content: Optional[List[CommentOutput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [CommentOutput.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
