...
class QuestionAnswerOutput(BaseModel):
    ...
    checked_answers: Optional[List[StrictInt]] = Field(default=None, alias="checkedAnswers")
    __properties: ClassVar[List[str]] = ["question", "checkedAnswers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "question": QuestionOutput.from_dict(obj["question"]) if obj.get("question") is not None else None,
            "checkedAnswers": obj.get("checkedAnswers")
        })
        return _obj
