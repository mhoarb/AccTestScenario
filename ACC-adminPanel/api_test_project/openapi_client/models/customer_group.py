...
class CustomerGroup(BaseModel):
    ...
    user_groups: Optional[List[CustomerUserGroup]] = Field(default=None, alias="userGroups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userGroups": [CustomerUserGroup.from_dict(_item) for _item in obj["userGroups"]] if obj.get("userGroups") is not None else None
        })
        return _obj

from openapi_client.models.customer_user_group import CustomerUserGroup
# TODO: Rewrite to not use raise_errors
CustomerGroup.model_rebuild(raise_errors=False)
