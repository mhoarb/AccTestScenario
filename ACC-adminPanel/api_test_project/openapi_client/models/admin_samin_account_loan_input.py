...
class AdminSaminAccountLoanInput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountNumber", "customerId", "loanType"]
    ...
    def loan_type_validate_enum(cls, value):
        ...
        if value not in set(['QARZ_AL_HASANA', 'MURABAHAH']):
            raise ValueError("must be one of enum values ('QARZ_AL_HASANA', 'MURABAHAH')")
        return value
