...
class PageReportGiftUserOutput(BaseModel):
    """
    ...
    content: Optional[List[ReportGiftUserOutput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [ReportGiftUserOutput.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
