...
class VotingOutput(BaseModel):
    ...
    options: Optional[List[VotingOptionOutput]] = None
    is_active: Optional[StrictBool] = Field(default=None, alias="isActive")
    __properties: ClassVar[List[str]] = ["id", "title", "options", "isActive"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "title": obj.get("title"),
            "options": [VotingOptionOutput.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
