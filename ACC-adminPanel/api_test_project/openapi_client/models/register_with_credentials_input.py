...
class RegisterWithCredentialsInput(BaseModel):
    """
    ...
    cif: StrictStr
    id_number: Annotated[str, Field(min_length=10, strict=True, max_length=10)] = Field(alias="idNumber")
    mobile_number: Optional[StrictStr] = Field(default=None, alias="mobileNumber")
    __properties: ClassVar[List[str]] = ["name", "lastName", "cif", "idNumber", "mobileNumber"]
