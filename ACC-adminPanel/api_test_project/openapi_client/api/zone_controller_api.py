...
class ZoneControllerApi:
    ...
    def create_zone(
        ...
        :param zone_input: (required)
        :type zone_input: ZoneInput
    ...
    def load_all28(
        ...
        _param = self._load_all28_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def load_all28_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
